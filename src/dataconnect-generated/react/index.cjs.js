const { listPostsRef, getOutfitsRef, listAllUsersRef, getUserProfileRef, createUserRef, updateUserProfileRef, createPostRef, connectorConfig } = require('../index.cjs.js');
