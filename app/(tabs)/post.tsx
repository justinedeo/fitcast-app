...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 16, fontWeight: "bold", color: "#0D4C92", marginTop: 14, marginBottom: 8 },
  subLabel: { fontSize: 13, fontWeight: "600", color: "#59C1BD", marginBottom: 8 },
  materialBox: { backgroundColor: "#fff", borderRadius: 12, padding: 12, marginTop: 8, borderWidth: 1, borderColor: "#D9E2EC" },
  input: { backgroundColor: "#fff", borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: "#D9E2EC", fontSize: 16 },
  imageBox: { height: 220, backgroundColor: "#fff", borderRadius: 10, justifyContent: "center", alignItems: "center", marginBottom: 8, overflow: "hidden", borderWidth: 1, borderColor: "#D9E2EC" },
  imageText: { color: "#8689A0", fontSize: 16 },
  image: { width: "100%", height: "100%" },
  tagContainer: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 4 },
  tag: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1.5, borderColor: "#C4CDD6", backgroundColor: "#fff" },
  tagText: { fontSize: 13, color: "#4A5568", fontWeight: "500" },
  tagTextActive: { color: "#fff", fontWeight: "600" },
  zipRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 8 },
  detectBtn: { backgroundColor: "#59C1BD", paddingHorizontal: 14, paddingVertical: 12, borderRadius: 10 },
  detectBtnText: { color: "#fff", fontWeight: "600", fontSize: 14 },
  privacyRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#fff", borderRadius: 12, padding: 14, marginTop: 14, borderWidth: 1, borderColor: "#D9E2EC" },
  privacyText: { flex: 1, marginRight: 12 },
  privacySubtext: { fontSize: 12, color: "#8689A0", marginTop: 2 },
  button: { backgroundColor: "#134E96", paddingVertical: 14, borderRadius: 25, alignItems: "center", marginTop: 20 },
